...
const outDir = path.join(__dirname, 'tms-api-hha-visit415-asset');
const outfile = path.join(outDir, 'index.mjs');
const zipPath = path.join(__dirname, 'tms-api-hha-visit415.zip');
...
fs.writeFileSync(
  path.join(__dirname, 'cdk-tms-hha-visit415-deploy-out.txt'),
  [
