...
const outDir = path.join(__dirname, 'tms-api-signnow-rest-asset');
const outfile = path.join(outDir, 'index.mjs');
const zipPath = path.join(__dirname, 'tms-api-signnow-rest.zip');
...
console.log('wrote cdk-tms-signnow-rest-deploy-out.txt');
