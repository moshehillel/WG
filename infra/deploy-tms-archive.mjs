...
const outDir = path.join(__dirname, 'tms-api-archive-asset');
const outfile = path.join(outDir, 'index.mjs');
const zipPath = path.join(__dirname, 'tms-api-archive.zip');
...
fs.writeFileSync(
  path.join(__dirname, 'cdk-tms-archive-deploy-out.txt'),
  [
    'Uploads & timesheets archive',
    `Function: ${fnName}`,
    out.trim(),
    env.trim(),
