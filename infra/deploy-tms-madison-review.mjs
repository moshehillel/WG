...
const outDir = path.join(__dirname, 'tms-api-madison-review-asset');
const outfile = path.join(outDir, 'index.mjs');
const zipPath = path.join(__dirname, 'tms-api-madison-review.zip');
...
console.log('env check (sandbox expected):', env);
