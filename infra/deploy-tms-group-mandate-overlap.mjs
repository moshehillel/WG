...
const outDir = path.join(__dirname, 'tms-api-group-mandate-overlap-asset');
const outfile = path.join(outDir, 'index.mjs');
const zipPath = path.join(__dirname, 'tms-api-group-mandate-overlap.zip');
...
fs.writeFileSync(
  ...
  [
    'TMS dual group-mandate overlap + groupSize cap',
    `Function: ${fnName}`,
    out.trim(),
    env.trim(),
